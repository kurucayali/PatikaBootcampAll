...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    handleNotebookOperations(warehouse, scanner);
                    break;
                case 2:
                    handleMobilePhoneOperations(warehouse, scanner);
                    break;
                case 3:
    ...
    private static void handleNotebookOperations(Warehouse warehouse, Scanner scanner) {
    ...
    private static void handleMobilePhoneOperations(Warehouse warehouse, Scanner scanner) {
